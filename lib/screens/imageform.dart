...
class _ImageFormState extends State<ImageForm> {
  ...
  void initState() {
    super.initState();
    DescNotifier descNotifier = Provider.of<DescNotifier>(
        context, listen: false);

    if (descNotifier.currentDesc != null) {
      _currentDesc = descNotifier.currentDesc;
    } else {
      _currentDesc = Description();
    }
  ...
  _saveFood() {
    ...
    uploadDescAndImage(
        _currentDesc widget.isUpdating, _imageFile, _onImageUploaded);
