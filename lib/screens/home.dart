    ...
    return Scaffold(
        ...
        body: ListView.separated(
          itemBuilder: (BuildContext context, int index) {
            return ListTile(
              leading: Image.network(descNotifier.desclist[index].image),
              width: 120,
              fit: BoxFit.fitWidth,
              title: Text(descNotifier.desclist[index].title),
              subtitle: Text(descNotifier.desclist[index].location),
              onTap: () {
                descNotifier.currentDesc = descNotifier.desclist[index];
          ...
          itemCount: descNotifier.desclist.length,
